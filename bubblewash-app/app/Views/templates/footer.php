    ...
    <footer class="bg-dark text-light py-4 mt-5">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h5>🫧 BubbleWash</h5>
                    <p class="mb-0">Your trusted car wash service</p>
                </div>
                <div class="col-md-6 text-md-end">
                    <p class="mb-0">&copy; <?= date('Y') ?> BubbleWash. All rights reserved.</p>
                    <small class="text-muted">Built with CodeIgniter 4 & Bootstrap 5</small>
                </div>
            </div>
        </div>
    </footer>
